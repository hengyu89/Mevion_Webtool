    ...
    sections: [
      {
        ...
        type: "text",
        content:
          "1. 修复不完整日志中病人上下文串用导致 Frac / 射野归属错误；<br>2. 缺少计划打开消息时从 SESSION 路径推定开始时间，并以 ≈ 标记；<br>3. 保留定位、复位及只打开计划的病人活动；有出束的射野加粗，未见出束的射野淡化；<br>4. HALO 下载的 TC Log 存在信息缺失风险；如需参考完整日志，建议通过 Bomgar 下载设备端原始 TC Log，并确认文件覆盖所需时间范围。",
        history: [
          {
            version: "v2.1.1",
            date: "2026/7/24",
