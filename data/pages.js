...
const pageContent = {
  home: {
    ...
    sections: [
      {
        title: "更新内容 v.2.1.2 — 2026/8/31",
        type: "text",
        content:
          "1. 修复不完整日志中病人上下文串用导致 Frac / 射野归属错误；<br>2. 缺少计划打开消息时从 SESSION 路径推定开始时间，并以 ≈ 标记；<br>3. 治疗人数与治疗射野仅采用已落盘的治疗野剂量记录，不显示未见出束的定位、复位或选野活动；<br>4. HALO 下载的 TC Log 存在信息缺失风险；如需参考完整日志，建议通过 Bomgar 下载设备端原始 TC Log，并确认文件覆盖所需时间范围。",
        history: [
          {
            version: "v2.1.1",
            date: "2026/7/24",
